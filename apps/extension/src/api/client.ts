import type { ExtensionMessageResponse, ExtensionMessageType, ExtensionRequestMap } from "./types";

export async function sendExtensionMessage<T extends ExtensionMessageType>(
  type: T,
